...
<?endif;?>
        ...
        <div class="table_content">
          <strong>Attack Proc:</strong> <? echo ($attack_proc != -1) ? "$proc_name (<a href=\"index.php?editor=spells&id=$attack_proc&action=2\">$attack_proc</a>) [<a href=\"http://lucy.allakhazam.com/spell.html?source=Live&id=$attack_proc\">Lucy</a>]" : "none";?><br>
<?if($attack_proc != -1):?>
...
<?$x=0; foreach($spells as $spell): extract($spell);?>
            <tr<?echo($x % 2 == 1) ? " bgcolor=\"#BBBBBB\"" : "";?>>
              <td><?=$name?> (<a href="index.php?editor=spells&id=<?=$spellid?>&action=2"><?=$spellid?></a>) [<a href="http://lucy.allakhazam.com/spell.html?source=Live&id=<?=$spellid?>">Lucy</a>]</td>
