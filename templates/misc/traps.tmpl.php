...
<? if (isset($traps)):?>
         <tr>
          ...
          <td align="center" width="5%"><strong>zdiff</strong></td>
          ...
          <td align="center" width="5%"><strong>val2</strong></td>
          ...
          <td align="center" width="5%"><strong>triggered</strong></td>
          <td align="center" width="5%"><strong>group</strong></td>
          <td align="center" width="5%"><strong>despawn</strong></td>
          <th width="5%"></th>
         </tr>
...
<?endif;?>    
<?if($v['effect'] == 1):?>   
          <td align="center" width="5%"><?=$alarmtype[$v['effectvalue2']]?></td>
<?endif;?>
<?if($v['effect'] < 1 || $v['effect'] > 1):?>
          <td align="center" width="5%"><?=$v['effectvalue2']?></td>
<?endif;?> 
          ...
          <td align="center" width="5%"><?=$v['triggered_number']?></td>
          <td align="center" width="5%"><?=$v['group']?></td>
          <td align="center" width="5%"><?=$v['despawn_when_triggered']?></td>
          <td align="right">      
