...
function copy_traps() {
   ...
   $query = "INSERT INTO traps (zone,x,y,z,chance,maxzdiff,radius,effect,effectvalue,effectvalue2,message,skill,level,respawn_time,respawn_var,triggered_number,groups,despawn_when_triggered) 
            SELECT zone,x,y,z,chance,maxzdiff,radius,effect,effectvalue,effectvalue2,message,skill,level,respawn_time,respawn_var,triggered_number,groups,despawn_when_triggered FROM traps WHERE zone=\"$z\" AND version=10000";
   $mysql->query_no_result($query);
