        ...
        <fieldset>
          ...
          <table width="100%" border="0" cellpadding="3" cellspacing="0">
            <tr>
              ...
              <td align="left" width="14%">OOC HP Regen:<br><input type="text" name="hp_regen_rate" size="5" value="0"></td>
              <td align="left" width="14%">Combat Regen:<br><input type="text" name="combat_hp_regen" size="5" value="0"></td>
