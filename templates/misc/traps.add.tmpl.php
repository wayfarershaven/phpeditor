      ...
      <div class="edit_form_content">
        ...
        <table width="100%">
          ...
          <tr>
            ...
            <td><input type="text" size="10" name="version" value="<?=$suggestver?>"></td>
          </tr>
          <tr>
            <th>effectvalue</th>
            <th>effectvalue2</th>
...
<?$x++; endforeach;?>
            ...
            <tr>
                ...
                <td><input type="text" size="10" name="group" value="0"></td>
                <td><input type="text" size="7" name="despawn_when_triggered" value="0"></td>
                <td colspan="5"><input type="text" size="59" name="message" value="<?=$message?>"></td>
            </tr>
              </table><br><br>
        <center>
