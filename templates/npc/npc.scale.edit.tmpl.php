        ...
        <fieldset>
          ...
          <table width="100%" border="0" cellpadding="3" cellspacing="0">
            <tr>
              ...
              <td align="left" width="20%">OOC HP Regen:<br><input type="text" name="hp_regen_rate" size="5" value="<?=$scale['hp_regen_rate']?>"></td>
            ...
            <tr>
              ...
              <td align="left" width="20%">Combat Regen::     <br><input type="text" name="combat_hp_regen" size="5" value="<?=$scale['combat_hp_regen']?>"></td>
