      ...
      <div class="edit_form_content">
        ...
        <table width="100%">
          ...
          <tr>
            ...
            <td><input type="text" size="10" name="version" value="<?=$version?>"></td>
          </tr>
          <tr>  
            <th>effectvalue</th>
            <th>effectvalue2</th>
...
<?endforeach;?>       
          ...
          <tr>
              ...
              <td><input type="text" size="7" name="despawn_when_triggered" value="<?=$despawn_when_triggered?>"></td>
              <td colspan="5"><input type="text" size="56" name="message" value="<?=$message?>"></td>
          </tr>
              </table><br><br>
        <center>
